...
[.cue]
****
There is a subtle thing in this demo of syntax, I can't show what the result is here.
****
...
//FIXME list of admonitions in cue
...
[.cue]
****
Face the bad side of things when using this
****
